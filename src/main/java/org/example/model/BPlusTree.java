...
public class BPlusTree {
    ...
    public void printInternals(BPlusInternal[] nodes) {
        ...
        if (nextNodes[0] instanceof BPlusInternal) {
            ...
            printLeaves((BPlusLeaf[]) nextNodes);
    }
    ...
    public BPlusLeaf findLeafNode(int elem) {
        ...
        if (child instanceof BPlusLeaf)
            return (BPlusLeaf) child;
        else
            return findLeafNode((BPlusInternal) child, elem);
    }
    ...
    public BPlusLeaf findLeafNode(BPlusInternal node, int elem) {
        ...
        if (child instanceof BPlusLeaf)
            ...
            return findLeafNode((BPlusInternal) node.getPointers()[i], elem);
    }
